...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        posible para que pudiera usarse incluso durante el ejercicio.`}],lE=()=>{const[s,e]=Ns.useState(0),n=Ns.useRef([]),r=()=>{e(f=>f===0?Xc.length-1:f-1)},a=()=>{e(f=>f===Xc.length-1?0:f+1)},u=async f=>{const d=n.current[f];if(d)if(document.fullscreenElement)await document.exitFullscreen();else try{await d.requestFullscreen()}catch(p){console.error("Error attempting to enable fullscreen:",p)}};return Te.jsxs("section",{className:"projects",children:[Te.jsx("h2",{children:"Proyectos"}),Te.jsx("div",{className:"slider",children:Xc.map((f,d)=>Te.jsxs("div",{className:`slide ${d===s?"active":""}`,children:[Te.jsx("h3",{children:f.title}),Te.jsxs("div",{className:"iframe-container",children:[Te.jsx("iframe",{ref:p=>n.current[d]=p,src:f.url,title:f.title}),Te.jsxs("div",{className:"iframe-controls",children:[Te.jsxs("button",{onClick:()=>u(d),className:"icon-button","aria-label":"Pantalla completa",children:[Te.jsx(oE,{}),Te.jsx("span",{children:"Pantalla Completa"})]}),Te.jsxs("a",{href:f.url,target:"_blank",rel:"noopener noreferrer",className:"icon-button","aria-label":"Abrir en nueva pestaña",children:[Te.jsx(aE,{}),Te.jsx("span",{children:"Abrir"})]})]})]}),Te.jsx("p",{children:f.description}),Te.jsxs("p",{children:["Tecnologías: ",f.technologies]}),Te.jsxs("details",{className:"project-details",children:[Te.jsxs("summary",{children:[Te.jsx(sE,{})," Historia del Proyecto"]}),Te.jsx("div",{style:{whiteSpace:"pre-line"},children:f.story})]})]},f.title))}),Te.jsxs("div",{className:"slider-controls",children:[Te.jsx("button",{onClick:r,children:"Anterior"}),Te.jsx("button",{onClick:a,children:"Siguiente"})]})]})},uE=()=>Te.jsxs("aside",{children:[Te.jsx("h2",{children:"Resumen"}),Te.jsx("p",{children:"Matemático por formación, desarrollador por pasión y curioso por naturaleza. Con una sólida base lógica, he aplicado mi conocimiento a proyectos educativos que integran tecnología y aprendizaje."}),Te.jsx("p",{children:"Mi objetivo es seguir creciendo profesionalmente en el mundo del desarrollo Full Stack. Soy un defensor de la innovación colaborativa y mi pasión es aprender, enseñar y crear."}),Te.jsx("p",{children:Te.jsx("em",{children:'"Donde otros ven un problema, yo veo una oportunidad de crear."'})}),Te.jsx("h2",{children:"Aptitudes"}),Te.jsx("h3",{children:"Técnicas"}),Te.jsx("p",{children:"JavaScript, NodeJS, Next.js, SQL, Python, React, Bootstrap, R"}),Te.jsx("h3",{children:"Blandas"}),Te.jsx("p",{children:"Trabajo en equipo, comunicación efectiva, excelentes relaciones interpersonales."}),Te.jsx("h2",{children:"Experiencia"}),Te.jsxs("ul",{children:[Te.jsx("li",{children:"Profesor de Matemática, I. Agrícola Pascual Baburriza (2024 - presente)"}),Te.jsx("li",{children:"Profesor nivelación Matemática, DUOC UC (2020 - 2023)"})]}),Te.jsx("h2",{children:"Formación"}),Te.jsxs("ul",{children:[Te.jsx("li",{children:"Adalid, Santiago: Especialización Front-End (Cursando)"}),Te.jsx("li",{children:"Talento digital, Santiago: Full Stack JavaScript (2024)"}),Te.jsx("li",{children:"Teleduc UC, Santiago: Programación con macros en Visual Basic para Excel (2022)"}),Te.jsx("li",{children:"PUC Chile, Santiago: Pedagogía en educación media mención Matemática (2019)"})]}),Te.jsx("h2",{children:"Idiomas"}),Te.jsxs("ul",{children:[Te.jsx("li",{children:"Español: Nativo"}),Te.jsx("li",{children:"Inglés: Intermedio (B1), certificado TOEFL"})]})]}),cE=()=>Te.jsxs(Te.Fragment,{children:[Te.jsx(KM,{}),Te.jsxs("main",{className:"container",children:[Te.jsx(ZM,{}),Te.jsxs("div",{className:"content-wrapper",children:[Te.jsx(uE,{}),Te.jsx(lE,{})]})]})]});G_.createRoot(document.getElementById("root")).render(Te.jsx(mr.StrictMode,{children:Te.jsx(cE,{})}));
